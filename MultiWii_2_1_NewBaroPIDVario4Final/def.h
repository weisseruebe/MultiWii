...
// Barologic Common Part

#if !(defined(MaxThrbaro))
  #define MaxThrbaro (MAXTHROTTLE-50)
#endif
#if !(defined(MinThrbaro))
  #define MinThrbaro (MINTHROTTLE+10)
#endif
#if !(defined(Barologic1)) && !(defined(Barologic2))
  #define Barologic1
#endif    
...
// Barologic2
 ...
 #endif 
 #if !(defined(Barologic2SpeedNROMAL)) && !(defined(Barologic2SpeedFASTER)) && !(defined(Barologic2SpeedFASTEST))
  #define Barologic2SpeedNROMAL
 #endif
 #if (defined(Barologic2SpeedNROMAL))
  #define Barologic2Speed 100000 // Normal
 #endif    
 #if (defined(Barologic2SpeedFASTER))
  #define Barologic2Speed 80000 // Faster
 #endif    
 #if (defined(Barologic2SpeedFASTEST))
  #define Barologic2Speed 60000 // Fastest
 #endif
#endif

// PositionHoldOverride
